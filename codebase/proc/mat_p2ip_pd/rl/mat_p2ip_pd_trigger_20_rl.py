...
if __name__ == '__main__':
    ...
    # ###################################################### #
    # ###################################################### #
    # dim_prot_complx_nm_lst_20_orig = ['2I25']
    dim_prot_complx_nm_lst_20_orig = ['1GXD', '1JTG', '1MAH', '1OC0', '1OPH', '1OYV', '1PPE', '1R0R', '1TMQ']
    # dim_prot_complx_nm_lst_20_orig = ['2I25', '4Y7M', '5JMO', '5SV3', '6CWG', '6DBG', '1AVX', '1AY7', '1BUH', '1BVN'] \
    ...
    dim_prot_complx_nm_lst_effective = [prot_id for prot_id in dim_prot_complx_nm_lst_20_orig if prot_id not in dim_prot_complx_nm_lst_excluded]
