...
if __name__ == '__main__':
    ...
    # ###################################################### #
    # ###################################################### #
    # dim_prot_complx_nm_lst_21_orig = ['2I25']
    dim_prot_complx_nm_lst_21_orig = ['1UDI', '1US7', '1YVB', '1Z5Y', '2A9K', '2ABZ', '2AYO', '2B42', '2J0T', '2O8V']
    # dim_prot_complx_nm_lst_21_orig = ['2I25', '4Y7M', '5JMO', '5SV3', '6CWG', '6DBG', '1AVX', '1AY7', '1BUH', '1BVN'] \
    ...
    dim_prot_complx_nm_lst_effective = [prot_id for prot_id in dim_prot_complx_nm_lst_21_orig if prot_id not in dim_prot_complx_nm_lst_excluded]
