...
if __name__ == '__main__':
    ...
    # ###################################################### #
    # ###################################################### #
    # dim_prot_complx_nm_lst_30_orig = ['2I25']
    dim_prot_complx_nm_lst_30_orig = ['2OOB', '2OUL', '2PCC', '2SIC', '2SNI', '2UUY', '3SGQ', '4CPA', '7CEI', '1AK4']
    # dim_prot_complx_nm_lst_30_orig = ['2I25', '4Y7M', '5JMO', '5SV3', '6CWG', '6DBG', '1AVX', '1AY7', '1BUH', '1BVN'] \
    ...
    dim_prot_complx_nm_lst_effective = [prot_id for prot_id in dim_prot_complx_nm_lst_30_orig if prot_id not in dim_prot_complx_nm_lst_excluded]
