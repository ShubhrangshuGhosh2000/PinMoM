...
def execute_md_simulation(**kwargs):
    ...
    gromacs.pdb2gmx_GPUIMPI(f=inp_pdb_pdb2gmx, o=out_gro_pdb2gmx, p=out_topol_pdb2gmx, i=out_itp_pdb2gmx, ff=forcefield_mdSim, water="tip3p", ignh=True)
    ...
    gromacs.editconf_GPUIMPI(f=inp_gro_editconf, o=out_gro_editconf, bt="dodecahedron", d=1.0, c=True, input="Protein")
    ...
    gromacs.solvate_GPUIMPI(cp=inp_gro_solvate, cs="spc216.gro", p=out_topol_pdb2gmx, o=out_gro_solvate)
    ...
    gromacs.grompp_GPUIMPI(f=inp_mdp_grompp_ion, o=out_tpr_grompp_ion, c=out_gro_solvate, p=out_topol_pdb2gmx, maxwarn=5)
    ...
    gromacs.genion_GPUIMPI(s=out_tpr_grompp_ion, o=out_gro_genion, conc=0.15, p=out_topol_pdb2gmx, pname="NA", nname="CL", neutral=True, input="SOL")  # 
    ...
    # Execute grompp command
    gromacs.grompp_GPUIMPI(f=inp_mdp_grompp_em, o=out_tpr_grompp_em, c=out_gro_genion, p=out_topol_pdb2gmx, maxwarn=5)
    ...
    # 'v' for verbose.
    gromacs.mdrun_GPUIMPI(v=True, ntomp=num_cpu_cores-2, pin='on', gpu_id=cuda_index_mdSim, s=inp_tpr_mdrun_em, o=out_trr_mdrun_em, c=out_gro_mdrun_em, e=out_edr_mdrun_em, g=out_log_mdrun_em)
    ...
    # Execute grompp command
    gromacs.grompp_GPUIMPI(f=inp_mdp_grompp_nvt, o=out_tpr_grompp_nvt, c=out_gro_mdrun_em, r=out_gro_mdrun_em
    ...
    # Execute mdrun command (https://manual.gromacs.org/current/onlinehelp/gmx-mdrun.html)
    # 'v' for verbose.
    gromacs.mdrun_GPUIMPI(v=True, ntomp=num_cpu_cores-2, pin='on', gpu_id=cuda_index_mdSim, s=inp_tpr_mdrun_nvt, cpo=out_cpt_mdrun_nvt, c=out_gro_mdrun_nvt
    ...
    # Execute grompp command
    gromacs.grompp_GPUIMPI(f=inp_mdp_grompp_npt, o=out_tpr_grompp_npt, c=out_gro_mdrun_nvt
    ...
    # Execute mdrun command (https://manual.gromacs.org/current/onlinehelp/gmx-mdrun.html)
    # 'v' for verbose.
    gromacs.mdrun_GPUIMPI(v=True, ntomp=num_cpu_cores-2, pin='on', gpu_id=cuda_index_mdSim, s=inp_tpr_mdrun_npt, cpo=out_cpt_mdrun_npt, c=out_gro_mdrun_npt
    ...
    # Execute grompp command
    gromacs.grompp_GPUIMPI(f=inp_mdp_grompp_prod, o=out_tpr_grompp_prod, c=out_gro_mdrun_npt
    ...
    # Execute mdrun command (https://manual.gromacs.org/current/onlinehelp/gmx-mdrun.html)
    # 'v' for verbose.
    gromacs.mdrun_GPUIMPI(v=True, ntomp=num_cpu_cores-2, pin='on', gpu_id=cuda_index_mdSim, s=inp_tpr_mdrun_prod
    ...
    gromacs.trjconv_GPUIMPI(input=('Protein', 'Protein'), s=inp_tpr_trjconv_analysis, f=inp_xtc_trjconv_analysis, o=out_xtc_trjconv_analysis, center=True, pbc="mol")
    ...
    # Execute rms command
    gromacs.rms_GPUIMPI(input=("Backbone", "Backbone"), s=inp_tpr_rms_analysis, f=inp_xtc_rms_analysis, o=out_xvg_rms_analysis, tu='ns', what='rmsd', xvg='none')
    ...
    gromacs.gyrate_GPUIMPI(input='Protein', s=inp_tpr_rg_analysis, f=inp_xtc_rg_analysis, o=out_xvg_rg_analysis, xvg='none')
    # generate and save dataframe
    ...
    gromacs.rmsf_GPUIMPI(input=("Backbone", "Backbone"), s=inp_tpr_rmsf_analysis, f=inp_xtc_rmsf_analysis, o=out_xvg_rmsf_analysis, xvg='none', res='yes')
    # generate and save dataframe
