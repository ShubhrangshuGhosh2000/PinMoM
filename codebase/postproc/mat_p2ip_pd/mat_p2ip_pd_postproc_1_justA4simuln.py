...
def run_postproc_1_just_after_simuln(**kwargs):
    """Postprocessing just after the simulation for the protein design through PPI.

    This method is called from a triggering method like mat_p2ip_pd_postproc_trigger.trigger_pd_postproc().
    """
    print('inside run_postproc_1_just_after_simuln() method - Start')
    print('####################################')
    ...
    print('inside run_postproc_1_just_after_simuln() method - End')
# End of run_postproc_1_just_after_simuln() method
