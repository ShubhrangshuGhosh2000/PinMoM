...
def lm_embed_pd(sequence, use_cuda=False, pre_trn_mdl=None, alphabet=None):
    """
    SPECIALLY ADDED FOR PROTEIN DESIGN BY INTERACTION.
    ...
    # pre_trn_mdl = get_pretrained("lm_v1")
    torch.nn.init.normal_(pre_trn_mdl.proj.weight)
    pre_trn_mdl.proj.bias = torch.nn.Parameter(torch.zeros(100))
    # if use_cuda:
    #     pre_trn_mdl = pre_trn_mdl.cuda()
    # pre_trn_mdl.eval()
